...
export default class SearchPage extends Component {
  ...
  submitHandler = (e) => {
    e.preventDefault();
   searchBook(this.state.inputValue).then((res)=>{this.setState({searchBookArr:res})
      ...
      <div className="search-container-bar">
       <Link to="/"> <button
        ...
        <form className="input-wrapper"onSubmit={this.submitHandler} >
          <input type="text" placeholder="Search..."value={this.state.inputValue} onChange={this.searchHandler}/>
        </form>
      </div>
